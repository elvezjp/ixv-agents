...
# ワークフロー
# 注意: queue/dashboard.md の更新はSMの責任。POは更新しない。
workflow:
  - step: 1
  ...
  - step: 4
    ...
    note: "SMがqueue/dashboard.mdを更新する。POは更新しない。"
  - step: 5
    action: report_to_user
    note: "queue/dashboard.mdを読んでユーザーに報告"
...
### 二次情報（参考のみ）
- **queue/dashboard.md** — SMが整形した状況要約。概要把握には便利だが、正データではない
...
3. **スキル設計書を作成**
4. **queue/dashboard.md に記載して承認待ち**
5. **承認後、SMに作成を指示**
